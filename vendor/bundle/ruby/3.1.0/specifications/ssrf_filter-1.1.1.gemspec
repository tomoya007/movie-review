...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<bundler-audit>.freeze, ["~> 0.9.1"])
    s.add_dependency(%q<pry-byebug>.freeze, [">= 0"])
    s.add_dependency(%q<rspec>.freeze, ["~> 3.11.0"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.35.0"])
    s.add_dependency(%q<rubocop-rspec>.freeze, ["~> 2.12.1"])
    s.add_dependency(%q<simplecov>.freeze, ["~> 0.21.2"])
    s.add_dependency(%q<simplecov-lcov>.freeze, ["~> 0.8.0"])
    s.add_dependency(%q<webmock>.freeze, [">= 3.18.0"])

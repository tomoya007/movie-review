# -*- encoding: utf-8 -*-
# stub: dry-schema 1.13.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<dry-logic>.freeze, [">= 1.5", "< 2"])
    ...
    s.add_dependency(%q<dry-configurable>.freeze, ["~> 1.0", ">= 1.0.1"])
    s.add_dependency(%q<dry-core>.freeze, ["~> 1.0", "< 2"])
    s.add_dependency(%q<dry-initializer>.freeze, ["~> 3.0"])
    s.add_dependency(%q<dry-logic>.freeze, [">= 1.5", "< 2"])

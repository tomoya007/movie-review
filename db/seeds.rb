...
Movie.create!(
  [
    {
      title:'多日想果',
  image:File.open('./app/assets/images/恋愛3.jpeg'),
  released_year:'2019',
  screening_time:'19',
  ...
  word: '応援は誰かの力になる！'
    ...
    {
      title:'チェルノブイリからの手紙',
  image:File.open('./app/assets/images/ドキュメンタリー8.jpeg'),
  released_year:'2012',
  screening_time:'75',
  ...
  word: '私が深呼吸できる場所'
    ...
    {
      title:'ENOLA（エノーラ）',
  image:File.open('./app/assets/images/アクション3.jpeg'),
  released_year:'2015',
  screening_time:'83',
  ...
  word:'力があるから破壊する'
    ...
    {
      title:'ユウカイ犯',
  image:File.open('./app/assets/images/サスペンス7.jpeg'),
  released_year:'2018',
  screening_time:'42',
  ...
  word: '姉を救え！異世界から！？'
    ...
    {
      title:'豆大福ものがたり',
  image:File.open('./app/assets/images/コメディ7.jpeg'),
  released_year:'2013',
  screening_time:'20',
  ...
  word: '家族をつなぐかき氷'
    ...
    {
      title:'ビート・パー・MIZU',
  image:File.open('./app/assets/images/恋愛5.jpeg'),
  released_year:'2019',
  screening_time:'27',
  ...
  word: '鳴りひびけ！恋のビート'
    ...
    {
      title:'私たちの家族',
  image:File.open('./app/assets/images/ドキュメンタリー1.jpeg'),
  released_year:'2021',
  screening_time:'31',
  ...
  word: '社会の差別と戦う理由'
    ...
    {
      title:'川凪ぐ火葬場',
  image:File.open('./app/assets/images/アニメーション2.jpeg'),
  released_year:'2022',
  screening_time:'13',
  ...
  word: 'いつか誰かの死と向き合う'
    ...
    {
      title:'キドラアローン　破壊の娘',
  image:File.open('./app/assets/images/アクション6.jpeg'),
  released_year:'2019',
  screening_time:'80',
  ...
  word: '記憶と共に失いたくない君'
    ...
    {
      title:'one two three',
  image:File.open('./app/assets/images/コメディ1.jpeg'),
  released_year:'2018',
  screening_time:'21',
  ...
  word: '君がいれば、大丈夫。'
    ...
    {
      title:'惑星ミズサ',
  image:File.open('./app/assets/images/恋愛9.jpeg'),
  released_year:'2014',
  screening_time:'96',
  ...
  word: '地球も僕もぐるぐるだ'
    ...
    {
      title:'ストロボライト',
  image:File.open('./app/assets/images/サスペンス4.jpeg'),
  released_year:'2013',
  screening_time:'122',
  ...
  word: 'その表情ははかなくも美しい'
    ...
    {
      title:'大鹿村から吹くパラム',
  image:File.open('./app/assets/images/ドキュメンタリー7.jpeg'),
  released_year:'2021',
  screening_time:'87',
  ...
  word: '山のため人のため挑むもの'
    ...
    {
      title:'カパエマフの魔法石',
  image:File.open('./app/assets/images/アニメーション3.jpeg'),
  released_year:'2020',
  screening_time:'8',
